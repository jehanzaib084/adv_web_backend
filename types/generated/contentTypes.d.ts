...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item_variant: Schema.Attribute.Relation<
      'oneToOne',
      'api::item-variant.item-variant'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiItemVariantItemVariant extends Struct.CollectionTypeSchema {
  collectionName: 'item_variants';
  info: {
    displayName: 'item_variant';
    pluralName: 'item-variants';
    singularName: 'item-variant';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    additional_price: Schema.Attribute.Integer;
...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    item_variants: Schema.Attribute.Relation<
      'oneToMany',
      'api::item-variant.item-variant'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    delivery_type: Schema.Attribute.Enumeration<
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Enumeration<['cash', 'card', 'online']>;
...
export interface ApiStaffStaff extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['manager', 'cashier', 'chef', 'rider']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::item-variant.item-variant': ApiItemVariantItemVariant;
